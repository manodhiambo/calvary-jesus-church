  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-cjc-cream">
        <section className="relative py-36 bg-cjc-navy overflow-hidden text-center">
          ...
          <div className="container mx-auto px-4">
            ...
            <h1 className="text-4xl md:text-6xl font-bold font-heading mb-4 text-white">Our Ministries</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold font-heading text-cjc-navy mb-2">Find Your Place to Serve & Grow</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {displayMinistries.map((ministry) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      <h3 className="text-xl font-semibold font-heading text-cjc-navy mb-2">{ministry.name || ministry.title}</h3>
                      {(ministry.age_group || ministry.ageGroup) && (
                        <p className="text-xs text-cjc-gold font-medium mb-2">{ministry.age_group || ministry.ageGroup}</p>
                      )}
        ...
        <section className="bg-cjc-navy text-white py-16 text-center">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold font-heading mb-4">Ready to Get Involved?</h2>
            <p className="text-lg max-w-xl mx-auto mb-6">
              Join one of our ministries and be part of something bigger. Experience the joy of serving others.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/contact" className="bg-white text-cjc-navy px-6 py-3 rounded-md font-semibold">
                Contact Us
              </Link>
          ...
          <Dialog.Panel className="bg-white max-w-2xl w-full rounded-xl p-6 overflow-y-auto max-h-[90vh] relative">
            ...
            {selectedMinistry && (
              <>
                ...
                <h3 className="text-2xl font-bold font-heading text-cjc-navy mb-2">{selectedMinistry.name || selectedMinistry.title}</h3>
